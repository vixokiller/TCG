...
export const CARD_DATABASE = [
  ...
  createCardRecord({ code: 'TK1-03-13', name: 'Rey Arturo Pendragón', image: '/assets/cards/Toolkit 2022: Red de Plata/Rey-arturo-pendragon-real.webp-1764009020037', type: 'Aliado', race: 'Caballero', ability: 'kingArthurPendragon', abilityKind: 'continua + disparada', text: 'Solo puedes tener en juego a un Rey Arturo Pendragón. Mientras esté en juego, tus Caballeros ganan + 1 a la fuerza y tu oponente bota 2 cartas en cada fase de agrupación. En respuesta a que sea destruido, puedes descartar 2 para salvarlo.', rarity: 'Real', edition: 'Espada Sagrada', product: 'Toolkit 2022: Red de Plata', unique: true, copyLimit: 1, invalidForDeck: true }),
  createCardRecord({ code: 'TK1-04-13', name: 'Tótem de Nwyre', image: '/assets/cards/Toolkit 2022: Red de Plata/Totem-de-nwyre-cortesano.webp-1762835274721', type: 'Tótem', ability: 'payOneDrawOne', abilityKind: 'activada', text: 'Paga 1 oro roba 1 carta.', rarity: 'Cortesano', edition: 'Espada Sagrada', product: 'Toolkit 2022: Red de Plata', copyLimit: 3 }),
];
