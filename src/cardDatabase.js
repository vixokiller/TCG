...
export const CARD_DATABASE = [
  ...
  createCardRecord({ code: 'USR-ALI-DRG-DOR', name: 'Dragón Dorado', cost: 4, strength: 5, type: 'Aliado', race: 'Dragón', text: 'Cuando juegues Dragón Dorado, destiérralo. Dragón Dorado puede ser jugado en cualquier momento para anular una carta. Carta Única.', rarity: 'Rara', edition: 'Usuario', product: 'Cartas agregadas', unique: true }),
  createCardRecord({ code: 'USR-TOT-GAITAS', name: 'Gaitas', cost: 2, type: 'Tótem', text: 'Continuo: tus Aliados en Línea de Defensa tienen +1 fuerza. En Robo, roba 1 carta adicional.', rarity: 'Infrecuente', edition: 'Usuario', product: 'Cartas agregadas' }),
];
