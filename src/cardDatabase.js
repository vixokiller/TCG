...
export const CARD_DATABASE = [
  ...
  createCardRecord({ code: 'USR-ALI-DRG-DOR', name: 'Dragón Dorado', cost: 4, strength: 5, type: 'Aliado', race: 'Dragón', text: 'Ímpetu. Entrada: roba 1 carta. Impacto: si no es bloqueado, destierra 1 carta adicional.', rarity: 'Rara', edition: 'Usuario', product: 'Cartas agregadas' }),
