...
5. Los Aliados se juegan en Línea de Defensa; durante Vigilia pueden moverse a Línea de Ataque.
6. La Batalla Mitológica se divide en Declaración de Ataque, Declaración de Bloqueadores, Guerra de Talismanes y Asignación de Daño.
7. Cada Aliado en Línea de Defensa puede bloquear a un solo Aliado atacante.
8. En Guerra de Talismanes, el jugador defensor recibe la primera preferencia; la preferencia alterna hasta que ambos pasen.
9. Las Armas se anexan a un Aliado; cada Aliado puede tener un Arma salvo que una habilidad diga lo contrario.
10. Si un Aliado anexado es destruido, su Arma también va al Cementerio. Si el Aliado se baraja en el Castillo, el Arma se baraja junto a él. Si el Aliado sube a la mano, el Arma se destruye.
11. El Cementerio recibe cartas descartadas, destruidas o enviadas por daño. El Destierro contiene cartas que normalmente no pueden recuperarse.
12. Pierde el jugador que queda sin cartas en su Castillo; el otro jugador gana.
...
3. Haz clic en un Aliado de tu Línea de Defensa durante Vigilia para moverlo a Línea de Ataque.
4. Avanza a Batalla Mitológica para declarar ataques, bloqueadores, Guerra de Talismanes y daño.
